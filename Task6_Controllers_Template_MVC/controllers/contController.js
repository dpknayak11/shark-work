const userDetails = []; // array initialized to store user details
...
exports.postAddContactus = (req,res,next) => {
    ...
    userDetails.push({ title : req.body.title}); //push the details into array
...
exports.getContactus = (req,res,next)=> {
    ...
    console.log(userDetails); //print the log on console with user details
    res.render('contactusData',{ //to render contact us data page
        prods : userDetails, //user details are passed
